...
h = 0.0003; % (h=0.0003 nondamped)(h=0.0005 damped)Passo del metodo numerico
e = 1.3; % (1.3 non-damped) (3 damped) Esponenziale per il nonlinear damping
kappa = 1; % Coefficiente nel potenziale di van der Pol
mu = 0.8; %0.8 per il caso smorzato per avere belle traiettorie % Coefficiente di smorzamento
